...
import org.dchbx.coveragehq.databinding.ResumeErrorBinding;
...
*/
public class ResumeErrorActivity extends BaseActivity {
    public static StateManager.UiActivity uiActivity = new StateManager.UiActivity(ResumeErrorActivity.class);
    //private ImageButton continueButton;

    private ResumeErrorBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.resume_error);
