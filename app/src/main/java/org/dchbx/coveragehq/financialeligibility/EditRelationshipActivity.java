...
*/
public class EditRelationshipActivity extends ApplicationQuestionsActivity {
    private static String TAG = "AddPersonActivity";
    public static StateManager.UiActivity uiActivity = new StateManager.UiActivity(EditRelationshipActivity.class);
    private Schema schema;
    private JsonObject from;
    private JsonObject cross;
    ...
    public void onCreate(Bundle bundle){
        ...
        from = new Gson().fromJson(stringExtra, JsonObject.class);
        stringExtra = intent.getStringExtra("Cross");
        cross = new Gson().fromJson(stringExtra, JsonObject.class);
        replacements = new HashMap<>();
        replacements.put("personfirstname1", from.get("personfirstname").getAsString());
        replacements.put("personfirstname2", cross.get("personfirstname").getAsString());
    }
