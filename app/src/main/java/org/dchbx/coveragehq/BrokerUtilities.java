...
public class BrokerUtilities {
    ...
    public static long daysLeftToApplicationDue(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear, LocalDate now) {
        return Utilities.dateDifferenceDays(now, planYear.renewalApplicationDue);
    }

    public static long daysLeft(org.dchbx.coveragehq.models.employer.PlanYear planYear, LocalDate today) throws Exception {
    ...
    public static long daysLeft(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear, LocalDate today) throws Exception {
        if (BrokerUtilities.isInOpenEnrollment(planYear, today)){
            return Utilities.dateDifferenceDays(today, planYear.openEnrollmentEnds);
        }
        return Utilities.dateDifferenceDays(today, planYear.renewalApplicationDue);
    ...
    private static org.dchbx.coveragehq.models.brokeragency.PlanYear getPlanYear(BrokerClient brokerClient, LocalDate planYear) throws Exception {
        for (org.dchbx.coveragehq.models.brokeragency.PlanYear year : brokerClient.planYears) {
    ...
    private static org.dchbx.coveragehq.models.employer.PlanYear getPlanYear(Employer employer, LocalDate planYear) {
    ...
    public static boolean isInOpenEnrollment(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear, LocalDate date){
        if (planYear.openEnrollmentBegins == null
                || planYear.openEnrollmentEnds == null){
            return false;
        }
    ...
    public static boolean isAlerted(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear) {
        return false;
    }
    ...
    public static org.dchbx.coveragehq.models.brokeragency.PlanYear getPlanYearForCoverageYear(BrokerClient brokerclient, LocalDate coverageYear) throws Exception {
        for (org.dchbx.coveragehq.models.brokeragency.PlanYear planYear : brokerclient.planYears) {
    ...
    public static int getEmployeesNeeded(org.dchbx.coveragehq.models.brokeragency.PlanYear planYearForCoverageYear) {
    ...
    public static org.dchbx.coveragehq.models.brokeragency.PlanYear getPendingRenewalPlanYear(BrokerClient brokerClient) throws Exception {
        for (org.dchbx.coveragehq.models.brokeragency.PlanYear planYear : brokerClient.planYears) {
    ...
    public static int daysLeftToRenewal(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear, LocalDate now) {
        return Days.daysBetween(planYear.openEnrollmentBegins, now).getDays();
    }

    public static boolean isPlanYearAlerted(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear) {
        return (planYear.employeesEnrolled + planYear.employeesWaived < planYear.minimumParticipationRequired);
    }

    public static boolean isInRenewal(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear) {
        return planYear.renewalInProgress;
    }

    public static org.dchbx.coveragehq.models.brokeragency.PlanYear getLastestPlanYear(List<org.dchbx.coveragehq.models.brokeragency.PlanYear> planYears) {
        if (planYears == null) {
            return null;
        }
        LocalDate date = new LocalDate(2000, 1, 1);
        org.dchbx.coveragehq.models.brokeragency.PlanYear foundPlanYear = null;
        for (org.dchbx.coveragehq.models.brokeragency.PlanYear planYear : planYears) {
    ...
    public static org.dchbx.coveragehq.models.brokeragency.PlanYear getMostRecentPlanYear(BrokerClient brokerClient) {
        org.dchbx.coveragehq.models.brokeragency.PlanYear mostRecentPlanYear = null;
        for (org.dchbx.coveragehq.models.brokeragency.PlanYear planYear : brokerClient.planYears) {
    ...
    public static BrokerClientStatus getBrokerClientStatus(org.dchbx.coveragehq.models.employer.PlanYear planYear, LocalDate date) {
    ...
    public static BrokerClientStatus getBrokerClientStatus(org.dchbx.coveragehq.models.brokeragency.PlanYear planYear, LocalDate date) {
        if (planYear.planYearBegins == null){
            return BrokerClientStatus.Other;
        }
